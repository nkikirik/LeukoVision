...
With **LeukoVision**, you can upload images, predict cell types with confidence scores, visualize Grad-CAM heatmaps, and compare the performance of different models for research and education.
</div>
